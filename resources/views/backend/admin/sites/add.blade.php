                ...
                <div class="col-md-6">
                 ...
                 <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <textarea name="accessibility" id="accessibility" required class="form-control omizixEditor" rows="3" placeholder="Description de l’accès, distance, moyens de transport..."></textarea>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="mb-3">
                        <label for="history" class="form-label omizixEditor">Histoire (facultatif)</label>
